...
class Bullet:
    def __init__(self,x,y,vel,screen,bul_speed,player,bul_index):#have to make it so bullets die after time or if they hit player or maybe object or out of bounds
